...
class   CustodyItem  extends StatelessWidget{
  ...
  CustodyItem({ required this.custody,  required this.index ,this.onReceiveClick});
  ...
  Widget build(BuildContext context) {
    ...
    return   Padding(padding: EdgeInsets.all(10.0) ,child: Card(
      ...
      child:Column(
       ...
       Padding(padding: EdgeInsets.all(10) , child:   CustomBtn(buttonNm: getTranslated("receive", context)??"", onClick:()=> onReceiveClick!() ,  backBtn:AppColors.logRed, txtColor: AppColors.white,),)
