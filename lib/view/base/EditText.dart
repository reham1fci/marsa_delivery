...
class EditText extends StatelessWidget{
 ...
 String? imageStr ;
  ...
  EditText({required this.hint,this.onTap ,   required this.edTextColor , required  this.error, this.image,required this.edTxtController ,this.imageStr, Key? key}): super(key: key);
